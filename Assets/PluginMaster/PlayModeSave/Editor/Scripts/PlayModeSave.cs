    ...
    public class PlayModeSave : UnityEditor.EditorWindow
    {
            ...
            public void Update()
            {
                ...
                foreach (var comp in components)
                {
                    ...
                    else if (comp is Cinemachine.CinemachineVirtualCamera)
                    {
                        ...
                        var CMBMCP = CMVCam.GetCinemachineComponent<Cinemachine.CinemachineBasicMultiChannelPerlin>();
                        if (CM3PF != null)
                            saveData = new CinemachineVirtualCameraSaveDataValue(data, saveCmd, CMVCam,
                                new Cinemachine3rdPersonFollowData(CM3PF));
                        else if (CMFT != null)
                            saveData = new CinemachineVirtualCameraSaveDataValue(data, saveCmd, CMVCam,
                                new CinemachineFramingTransposerData(CMFT));
                        else if (CMHLT != null)
                            saveData = new CinemachineVirtualCameraSaveDataValue(data, saveCmd, CMVCam,
                                new CinemachineHardLockToTargetData(CMHLT));
                        else if (CMOT != null)
                            saveData = new CinemachineVirtualCameraSaveDataValue(data, saveCmd, CMVCam,
                                new CinemachineOrbitalTransposerData(CMOT));
                        else if (CMTD != null)
                            saveData = new CinemachineVirtualCameraSaveDataValue(data, saveCmd, CMVCam,
                                new CinemachineTrackedDollyData(CMTD));
                        else if (CMT != null)
                            saveData = new CinemachineVirtualCameraSaveDataValue(data, saveCmd, CMVCam,
                                new CinemachineTransposerData(CMT));
                        else if (CMGC != null)
                            saveData = new CinemachineVirtualCameraSaveDataValue(data, saveCmd, CMVCam,
                                new CinemachineGroupComposerData(CMGC));
                        else if (CMC != null)
                            saveData = new CinemachineVirtualCameraSaveDataValue(data, saveCmd, CMVCam,
                                new CinemachineComposerData(CMC));
                        else if (CMPOV != null)
                            saveData = new CinemachineVirtualCameraSaveDataValue(data, saveCmd, CMVCam,
                                new CinemachinePOVData(CMPOV));
                        else if (CMSAFT != null)
                            saveData = new CinemachineVirtualCameraSaveDataValue(data, saveCmd, CMVCam,
                                new CinemachineSameAsFollowTargetData(CMSAFT));
                        else if (CMBMCP != null)
                            saveData = new CinemachineVirtualCameraSaveDataValue(data, saveCmd, CMVCam,
                                new CinemachineBasicMultiChannelPerlinData(CMBMCP));
        ...
        private static void Add(Component component, SaveCommand cmd, bool always, bool serialize)
        {
            ...
            SaveDataValue GetValue()
            {
                ...
                else if (component is Cinemachine.CinemachineVirtualCamera)
                {
                    ...
                    var CM3PF = CMVCam.GetCinemachineComponent<Cinemachine.Cinemachine3rdPersonFollow>();
                    if (CM3PF != null) return new CinemachineVirtualCameraSaveDataValue(data, cmd, CMVCam,
                            new Cinemachine3rdPersonFollowData(CM3PF));
                    var CMFT = CMVCam.GetCinemachineComponent<Cinemachine.CinemachineFramingTransposer>();
                    if (CMFT != null) return new CinemachineVirtualCameraSaveDataValue(data, cmd, CMVCam,
                            new CinemachineFramingTransposerData(CMFT));
                    var CMHLT = CMVCam.GetCinemachineComponent<Cinemachine.CinemachineHardLockToTarget>();
                    if (CMHLT != null) return new CinemachineVirtualCameraSaveDataValue(data, cmd, CMVCam,
                            new CinemachineHardLockToTargetData(CMHLT));
                    var CMOT = CMVCam.GetCinemachineComponent<Cinemachine.CinemachineOrbitalTransposer>();
                    if (CMOT != null) return new CinemachineVirtualCameraSaveDataValue(data, cmd, CMVCam,
                            new CinemachineOrbitalTransposerData(CMOT));
                    var CMTD = CMVCam.GetCinemachineComponent<Cinemachine.CinemachineTrackedDolly>();
                    if (CMTD != null) return new CinemachineVirtualCameraSaveDataValue(data, cmd, CMVCam,
                            new CinemachineTrackedDollyData(CMTD));
                    var CMT = CMVCam.GetCinemachineComponent<Cinemachine.CinemachineTransposer>();
                    if (CMT != null) return new CinemachineVirtualCameraSaveDataValue(data, cmd, CMVCam,
                            new CinemachineTransposerData(CMT));
                    var CMGC = CMVCam.GetCinemachineComponent<Cinemachine.CinemachineGroupComposer>();
                    if (CMGC != null) return new CinemachineVirtualCameraSaveDataValue(data, cmd, CMVCam,
                            new CinemachineGroupComposerData(CMGC));
                    var CMC = CMVCam.GetCinemachineComponent<Cinemachine.CinemachineComposer>();
                    if (CMC != null) return new CinemachineVirtualCameraSaveDataValue(data, cmd, CMVCam,
                            new CinemachineComposerData(CMC));
                    var CMPOV = CMVCam.GetCinemachineComponent<Cinemachine.CinemachinePOV>();
                    if (CMPOV != null) return new CinemachineVirtualCameraSaveDataValue(data, cmd, CMVCam,
                            new CinemachinePOVData(CMPOV));
                    var CMSAFT = CMVCam.GetCinemachineComponent<Cinemachine.CinemachineSameAsFollowTarget>();
                    if (CMSAFT != null) return new CinemachineVirtualCameraSaveDataValue(data, cmd, CMVCam,
                            new CinemachineSameAsFollowTargetData(CMSAFT));
                    var CMBMCP = CMVCam.GetCinemachineComponent<Cinemachine.CinemachineBasicMultiChannelPerlin>();
                    if (CMBMCP != null) return new CinemachineVirtualCameraSaveDataValue(data, cmd, CMVCam,
                            new CinemachineBasicMultiChannelPerlinData(CMBMCP));
        ...
        private static void Apply(ComponentSaveDataKey key)
        {
            if (CompDataContainsKey(ref key))
            {
                ...
                else if (value is CinemachineVirtualCameraSaveDataValue)
                {
                    ...
                    var CMVC = comp as Cinemachine.CinemachineVirtualCamera;
                    var CM3PF = CMVC.GetCinemachineComponent<Cinemachine.Cinemachine3rdPersonFollow>();
                    if (CM3PF != null) CMVCData.CMCompData.SetCompValues(CM3PF);
                    var CMFT = CMVC.GetCinemachineComponent<Cinemachine.CinemachineFramingTransposer>();
                    if (CMFT != null) CMVCData.CMCompData.SetCompValues(CMFT);
                    var CMHLT = CMVC.GetCinemachineComponent<Cinemachine.CinemachineHardLockToTarget>();
                    if (CMHLT != null) CMVCData.CMCompData.SetCompValues(CMHLT);
                    var CMOT = CMVC.GetCinemachineComponent<Cinemachine.CinemachineOrbitalTransposer>();
                    if (CMOT != null) CMVCData.CMCompData.SetCompValues(CMOT);
                    var CMTD = CMVC.GetCinemachineComponent<Cinemachine.CinemachineTrackedDolly>();
                    if (CMTD != null) CMVCData.CMCompData.SetCompValues(CMTD);
                    var CMT = CMVC.GetCinemachineComponent<Cinemachine.CinemachineTransposer>();
                    if (CMT != null) CMVCData.CMCompData.SetCompValues(CMT);
                    var CMGC = CMVC.GetCinemachineComponent<Cinemachine.CinemachineGroupComposer>();
                    if (CMGC != null) CMVCData.CMCompData.SetCompValues(CMGC);
                    var CMC = CMVC.GetCinemachineComponent<Cinemachine.CinemachineComposer>();
                    if (CMC != null) CMVCData.CMCompData.SetCompValues(CMC);
                    var CMPOV = CMVC.GetCinemachineComponent<Cinemachine.CinemachinePOV>();
                    if (CMPOV != null) CMVCData.CMCompData.SetCompValues(CMPOV);
                    var CMSAFT = CMVC.GetCinemachineComponent<Cinemachine.CinemachineSameAsFollowTarget>();
                    if (CMSAFT != null) CMVCData.CMCompData.SetCompValues(CMSAFT);
                    var CMBMCP = CMVC.GetCinemachineComponent<Cinemachine.CinemachineBasicMultiChannelPerlin>();
                    if (CMBMCP != null) CMVCData.CMCompData.SetCompValues(CMBMCP);
                }
#endif
            }
        }
        ...
        private static class ApplicationEventHandler
        {
            ...
            private static bool IsPackageInstalled(string packageId)
            {
                ...
                var manifestJson = System.IO.File.ReadAllText("Packages/manifest.json");
                return manifestJson.Contains(packageId);
            }

            private static void UpdatePackageDefine(string packageId, string define)
            {
